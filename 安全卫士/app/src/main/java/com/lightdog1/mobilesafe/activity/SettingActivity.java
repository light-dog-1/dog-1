...
import com.lightdog1.mobilesafe.service.AddressService;
import com.lightdog1.mobilesafe.service.BlackNumberService;
import com.lightdog1.mobilesafe.utils.ConstantValue;
import com.lightdog1.mobilesafe.utils.ServiceUtil;
import com.lightdog1.mobilesafe.utils.SpUtil;
import com.lightdog1.mobilesafe.view.SettingClickView;
import com.lightdog1.mobilesafe.view.SettingItemView;
...
public class SettingActivity extends Activity {
	...
	private void initBlacknumber() {
		...
		boolean isRunning = ServiceUtil.isRunning(this, "com.lightdog1.mobilesafe.service.BlackNumberService");
	...
	private void initAddress() {
		...
		//对服务是否开的状态做显示
		boolean isRunning = ServiceUtil.isRunning(this, "com.lightdog1.mobilesafe.service.AddressService");
